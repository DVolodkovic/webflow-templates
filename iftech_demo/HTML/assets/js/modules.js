(() => {
    var e = {
            ...
            1724: function() {
                ...
                function e(e) {
                    window.Animations && window.Animations.env && window.Animations.env("design") || ($("video").each(function() {
                ...
                "undefined" != typeof window && $(document).ready(() => {
                    ...
                    n.addEventListener("change", t => {
                        ...
                        if (window.Animations && window.Animations.env && window.Animations.env("design")) return;
            ...
            4345: function(e, t, i) {
                ...
                n.define("slider", e.exports = function(e, t) {
                    ...
                    function g() {
                        (i = f.find(h)).length && (i.each(b), s || (y(), n.resize.on(w), n.redraw.on(l.redraw)))
                    }
                    ...
                    function O(t, i, n) {
                        return function(a) {
                            ...
                            i ? (t.ariaLiveLabel.attr("aria-live", "polite"), t.hasTimer && R(t)) : (t.ariaLiveLabel.attr("aria-live", "off"), t.hasTimer && L(t))
                        }
                    }
                    ...
                    function C(i) {
                        return function(a, o) {
                            ...
                            if (d && "setting" === a.type) {
                                ...
                                return s = o.select, l = null, s === i.slides.length && (g(), P(i)), t.each(i.anchors, function(t, i) {
                            ...
                            if ("swipe" === a.type) return c.disableSwipe || n.env("editor") ? void 0 : "left" === o.direction ? W(i)() : "right" === o.direction ? T(i)() : void 0;
                    ...
                    function S(t, i) {
                        ...
                        var r = i.index,
                            s = {};
                        r < 0 ? (r = a.length - 1, n.infinite && (s.x = -t.endX, s.from = 0, s.to = a[0].width)) : r >= a.length && (r = 0, n.infinite && (s.x = a[a.length - 1].width, s.from = -a[a.length - 1].x, s.to = s.from - s.x)), t.index = r;
                        ...
                        var f = t.offsetX || 0,
                            ...
                            O = "opacity " + x + "ms " + b,
                            E = "transform " + x + "ms " + b;
                        if (p.find(o).removeAttr("tabindex"), p.removeAttr("aria-hidden"), p.find("*").removeAttr("aria-hidden"), y.find(o).attr("tabindex", "-1"), y.attr("aria-hidden", "true"), y.find("*").attr("aria-hidden", "true"), d || (p.each(v.intro), y.each(v.outro)), i.immediate && !m) {
                            c(p).set(h), L();
                            return
                        }
                        if (t.index !== t.previous) {
                            if (d || t.ariaLiveLabel.text(`Slide ${r+1} of ${a.length}.`), "cross" === w) {
                                var T = Math.round(x - x * n.crossOver),
                                    W = Math.round(x - T);
                                O = "opacity " + T + "ms " + b, c(g).set({
                                    visibility: ""
                                }).add(O).start({
                                    opacity: 0
                                }), c(p).set({
                            ...
                            n.infinite && s.x ? (c(t.slides.not(g)).set({
                                visibility: "",
                                x: s.x
                            }).add(E).start({
                                x: u
                        ...
                        function L() {
                            p = e(a[t.index].els), y = t.slides.not(p), "slide" !== w && (h.visibility = "hidden"), c(y).set(h)
                        }
                    }

                    function j(t, i) {
                        var n, a, r, o, s = e.data(i, h);
                        if (s) {
                            if (a = (n = s).mask.width(), n.maskWidth !== a && (n.maskWidth = a, 1)) return P(s);
                            d && (o = 0, (r = s).slides.each(function(t, i) {
                                o += e(i).outerWidth(!0)
                            }), r.slidesWidth !== o && (r.slidesWidth = o, 1)) && P(s)
                        }
                    }
                    ...
                    function P(t) {
                        ...
                        s < 0 && (s = 0), t.anchors = [{
                            ...
                            a - n > s && (i++, n += o, t.anchors[i - 1] = {
                                els: [],
                                x: a,
                                width: 0
                            }), r = e(l).outerWidth(!0), a += r, t.anchors[i - 1].width += r, t.anchors[i - 1].els.push(l);
                            var c = d + 1 + " of " + t.slides.length;
                            e(l).attr("aria-label", c), e(l).attr("role", "group")
                        }), t.endX = a, d && (t.pages = null), t.nav.length && t.pages !== i && (t.pages = i, function(t) {
                            var i, n = [],
            ...
            8631: function(e, t, i) {
                i(9461), i(7624), i(286), i(8334), i(2338), i(3695), i(322), i(941), i(5134), i(9858), i(9904), i(1724), i(4345), i(5333)
            }
        },
        t = {};
    ...
    i.m = e, i.d = (e, t) => {
        ...
        i.O = (t, n, a, r) => {
            ...
            for (var d = 1 / 0, o = 0; o < e.length; o++) {
                for (var [n, a, r] = e[o], s = !0, l = 0; l < n.length; l++)(!1 & r || d >= r) && Object.keys(i.O).every(e => i.O[e](n[l])) ? n.splice(l--, 1) : (s = !1, r < d && (d = r));
                if (s) {
                    e.splice(o--, 1);
                    var c = a();
                    void 0 !== c && (t = c)
    ...
    var n = i.O(void 0, ["87", "422"], function() {
        return i(8631)
    });
    n = i.O(n)
})();